  ...
  return (
    <div className="space-y-12 bg-white min-h-screen">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 mx-4 border border-purple-100">
        ...
        <div className="text-center">
            <img
              src="https://i.postimg.cc/13Dg93MZ/chirag-1.jpg"
              alt="CHIRAG"
              className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
            />
            <h3 className="text-xl font-semibold text-gray-800">CHIRAG</h3>
            <p className="text-orange-500 font-medium">23BCE11344</p> 
          </div>

          <div className="text-center">
            <img
              src="https://i.postimg.cc/QVLgVnT4/praveen-1.jpg"
              alt="PRAVEEN MAGANTI"
              className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
            />
            <h3 className="text-xl font-semibold text-gray-800">PRAVEEN MAGANTI</h3>
            <p className="text-orange-500 font-medium">23BCE9363</p> 
          </div>

          <div className="text-center">
            <img
              src="https://i.postimg.cc/prpDLM1M/raja-2.jpg"
              alt="RAJKUMAR REDDY DAKA"
              className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
            />
            <h3 className="text-xl font-semibold text-gray-800">RAJKUMAR REDDY DAKA</h3>
            <p className="text-orange-500 font-medium">23BCE9799</p> 
          </div>

          <div className="text-center">
            <img
              src="https://i.postimg.cc/prCcjvPG/manu.jpg"
              alt="VENKATA MANU ROHITH GANGHAM"
              className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
            />
            <h3 className="text-xl font-semibold text-gray-800">VENKATA MANU ROHITH GANGHAM</h3>
            <p className="text-orange-500 font-medium">23BCE7148</p> 
          </div>
        </div>
      </div>
